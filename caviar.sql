...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 29, 2018 at 08:35 PM
...
(8, 'Amran Hossain', 'amran@gmail.com', 'About Your company', 'I want to know about your compoany', 1, '2018-11-27 05:54:02', NULL);
...
CREATE TABLE `members` (
  ...
  `member_date_of_birth` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(1, 'afaf', 'kjafhkjha@gmail.com', 'aifjkaf', 'jkljfklsjaflkj', 'kfjsklafjl', 'fklajfskljlk', 'fjklajfkl', 'kljfklasjfl', 'fkllk', 1, '2018-11-27 06:47:54', NULL);
...
(1, 'Nafiew Hasan', 'nafiew@gmail.com', NULL, '$2y$10$5DCe2/jFZIrKHDg9.5ku/e86a6fI2olxLqvHRXLF9FaQrb0.KXcgi', 1, 'loludtFonZ4oKutSiZcj9C9UzGAmhRJEzGbNb1wfnAZv7DEOTWQpCuSujsfw', 1, '2018-11-24 12:51:04', '2018-11-24 12:51:04'),
...
(4, 'Anuradha Roy', 'anu@gmail.com', NULL, '$2y$10$ec2MaO6YUQnMw2LD4pkcwOqEcXqVFVXgvMmBgX4tsjU2invjbv0Bm', 2, 'vsrkm44zMf7ynT4eVrPcW2S1bxbtbly7FJgXo7W3NoN0VExoCrw8dwRjYYiU', 1, '2018-11-25 03:48:04', '2018-11-25 03:48:04'),
...
--
ALTER TABLE `contactuses`
  MODIFY `contactus_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
